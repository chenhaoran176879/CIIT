...
if [[ $local_rank == 0 ]]; then
    ...
    ${train_script} \
    --config_file="./mm_interleaved/configs/release/mm_eval.yaml" \
    --output_dir="/mnt/lustre/chenhaoran/CIIT/MM-interleaved/OUTPUT/mm_pretrain_eval"
fi