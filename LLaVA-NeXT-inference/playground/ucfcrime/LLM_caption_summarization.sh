#!/bin/bash
#SBATCH --job-name=summarization  # create a short name for your job
...
python -u /mnt/lustre/chenhaoran/CIIT/LLaVA-NeXT-inference/playground/ucfcrime/LLM_caption_summarization.py
