...
# 手动填写 model_path
NFRAMES=32
MODEL_PATH="/home/share/chenhaoran/model_zoo/qwen-vl2-72B"
...
# 生成 output_jsonl 的名称
OUTPUT_JSONL="/mnt/lustre/chenhaoran/CIIT/LLaVA-NeXT-inference/playground/ucfcrime/benchmark_results/eval_results_${MODEL_NAME}_${NFRAMES}frames.jsonl"
...
python -u /mnt/lustre/chenhaoran/CIIT/LLaVA-NeXT-inference/playground/ucfcrime/eval_UCVL.py \
       ...
       --data_split test \
       --questions anomaly_detection_question crime_classification_question event_description_question event_description_with_classification \
