...
def model_generate(model_path,model,inputs,tokenizer):
    if 'internvl' in model_path.lower():
        ...
        response, history = model.chat(tokenizer,generation_config,
                                history=None, return_history=True,**inputs)
        return response
...
def main():
    ...
    model_paths = [
        ...
        "/home/share/chenhaoran/model_zoo/OpenGVLab--InternVideo2_Chat_8B_InternLM2_5",
        ...
        "/home/share/chenhaoran/model_zoo/lmms-lab--llava-onevision-qwen2-72b-ov",
        "/home/share/chenhaoran/model_zoo/Qwen2-VL-7B-Instruct"
    ]

    #model_path = model_paths[0]
    for model_path in model_paths:
        print('get model:',model_path)
