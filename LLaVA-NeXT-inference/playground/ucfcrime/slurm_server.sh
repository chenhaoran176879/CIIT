#!/bin/bash
#SBATCH --job-name=server  # create a short name for your job
#SBATCH --nodes=1             # node count
#SBATCH --gres=gpu:1        # number of gpus per node
#SBATCH --ntasks-per-node=1
#SBATCH --cpus-per-task=8
#SBATCH -p ai_training
#SBATCH --nodelist dx-ai-node4
...
python -u /mnt/lustre/chenhaoran/CIIT/LLaVA-NeXT-inference/playground/ucfcrime/model_server.py
